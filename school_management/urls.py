...
urlpatterns = [
    ...
    path('question-paper/', include('apps.question_paper.urls', namespace='question_paper')),
    ...
    path('api/save-employee/', user_views.api_save_employee, name='api_save_employee'),
    path('api/employees/', user_views.api_get_employees, name='api_get_employees'),
    path('api/delete-employee/<str:emp_id>/', user_views.api_delete_employee, name='api_delete_employee'),
    path('api/toggle-employee/<str:emp_id>/', user_views.api_toggle_employee_status, name='api_toggle_employee_status'),
